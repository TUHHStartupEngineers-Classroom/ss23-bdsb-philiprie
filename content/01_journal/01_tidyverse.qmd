...
# Importing Files ----
bikes_tbl <- read_excel(path="01_tidyverse_files/01_bike_sales/01_raw_data/bikes.xlsx")
orderlines_tbl <- read_excel(path = "01_tidyverse_files/01_bike_sales/01_raw_data/orderlines.xlsx")
bikeshops_tbl  <- read_excel(path = "01_tidyverse_files/01_bike_sales/01_raw_data/bikeshops.xlsx")
